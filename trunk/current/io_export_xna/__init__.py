...
bl_addon_info = {
    ...
    "description": "Export XNA Keyframes (.clip format)",
    "warning": "",
...
def menu_export(self, context):
    from io_export_xna import export_xna
    import os
    default_path = os.path.splitext(bpy.data.filepath)[0] + ".clip"
    self.layout.operator(export_xna.XNAExporter.bl_idname, text="XNA Keyframes (.clip)").filepath = default_path
